=== /Users/superadmin/Downloads/super-mario-python-master/classes/Input.py ===
Description: Captures and processes keyboard input for player controls and menus.
Component: input
Role: input manager
...
class Input:
    ...
    def checkForKeyboardInput(self):
        ...
        isJumping = pressedKeys[K_LSHIFT] or pressedKeys[K_UP] or pressedKeys[K_k]
        self.entity.traits['jumpTrait'].jump(isJumping)

        self.entity.traits['goTrait'].boost = pressedKeys[K_SPACE]
